...
public class DropboxDownloadFile extends AsyncTask<Void, Long, Boolean> {
	...
	public DropboxDownloadFile(Context context, DropboxAPI<?> api, String dropboxPath,String newfile) {
        ...
        mDialog.setMax(100);
        mDialog.setMessage("Descargando " + newfile);
        mDialog.setProgressStyle(ProgressDialog.STYLE_HORIZONTAL);
        mDialog.setProgress(0);
        mDialog.setButton("Cancelar", new OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                DropboxDownloadFile.this.cancel(true);                
            }
        });
        mDialog.show();
    }
    ...
    protected void onProgressUpdate(Long... progress) {
        int percent = (int)((double)progress[0]);
